...
class OperationLeadController extends Controller
{
    public function index()
    {
        ...
        if (request()->expectsJson()) {
            try {
                ...
                $basicLeads = OperationLead::orderBy('created_at', 'desc')->get();
    ...
    public function show($id)
    {
        ...
        return view('admin.operation_leads.show', compact('lead', 'paymentInvoices', 'receivedPayments', 'vendors', 'filteredVendors', 'services', 'deploymentDetails', 'crm_lead', 'locations', 'executives'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // For mobile app updates, only validate the fields that are being sent
        if ($request->has('mobile_app') && $request->mobile_app) {
            $validationRules = [
            ...
            $validationRules = [
                ...
                'query' => 'required',
                'query_remark' => 'nullable|string',
                'status' => 'required|in:profile,profile pending,profile shared,closed,follow up,inactive,price issue',
                'shift_type' => 'nullable|in:12hr,24hr,both',
                'price_issue_remark' => 'nullable|string',
                'inactive_remark' => 'nullable|string',
                'patient_name' => 'nullable|string',
