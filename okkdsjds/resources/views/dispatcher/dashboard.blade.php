    ...
    <div class="content-wrapper pb-5">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Dispatcher Dashboard</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <a  href="{{ route('dispatcher.case.index', 'main_claim_cases') }}"
                            class="text-light">
                    ...
                    <div class="col-lg-3 col-6">
                        <a  href="{{ route('dispatcher.case.index', 'post_claim_cases') }}"
                            class="text-light">
                            <div class="small-box text-sm bg-secondary">
                                <div class="inner">
                    ...
                    <div class="col-lg-3 col-6">
                        <a  href="{{ route('dispatcher.case.index', 'post_two_claim_cases') }}"
                            class="text-light">
                            <div class="small-box text-sm bg-secondary">
                                <div class="inner">
