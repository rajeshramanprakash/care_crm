    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('operation-manager.jobproc.index') }}" class="nav-link {{ request()->routeIs('operation-manager.jobproc.*') ? 'active' : '' }}">
...
<script>
    ...
    setInterval(updateSidebarUnreadBadgeOperationManager, 5000);
</script>
