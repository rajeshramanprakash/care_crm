    ...
    <script>
        $(document).ready(function() {
            ...
            function loadStatusCounts() {
                $.ajax({
                    url: '{{ route("medicinevital.query.status-counts") }}',
                    method: 'GET',
            ...
            serverSide: false,
            ajax: {
                url: `{{ route('medicinevital_query_courier_ajax') }}`,
                data: function(d) {
        ...
        $(document).on('change', 'input[type="file"][name="pdf_file"]', function() {
            ...
            $.ajax({
                url: `/medicinevital/query/${id}/update-pdf`,
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.btn-view-files', function() {
            var caseId = $(this).data('id');
            $.ajax({
                url: '/medicine/query/files/' + caseId,
                method: 'GET',
                success: function(response) {
