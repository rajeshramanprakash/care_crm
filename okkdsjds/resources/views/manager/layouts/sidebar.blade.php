    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{route('manager.leads.index')}}" class="nav-link {{ strpos($route_name, 'leads') !== false ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{route('manager.chat.index')}}" class="nav-link {{ strpos($route_name, 'chat') !== false ? 'active' : '' }}">
...
<script>
    ...
    setInterval(updateSidebarUnreadBadgeManager, 5000);
</script>
