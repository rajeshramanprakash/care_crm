        ...
        <div class="modal-content" style="max-width: 600px;">
            ...
            <div class="modal-body">
                ...
                <div style="text-align: center;">
                    <a id="recordingDownloadLink" href="#" download class="btn btn-primary" style="display: inline-block;">
...
@section('footer-script')
    <script>
        ...
        function populateSalesRolesDropdown() {
            ...
            fetch('/admin/dashboard/sales-executives')
        ...
        function populateOperationRolesDropdown() {
            ...
            fetch('/admin/dashboard/operation-executives')
                .then(response => response.json())
                .then(data => {
                    dropdownIds.forEach(id => {
                        const rolesSelect = document.getElementById(id);
        ...
        function loadSalesLeadsData(period, startDate = null, endDate = null, selectedPeriod = null, executive = null) {
            ...
            let url = `/admin/dashboard/sales-leads-stats?period=${period}`;
        ...
        function loadOperationLeadsData(period, startDate = null, endDate = null, selectedPeriod = null, executive = null) {
            ...
            let url = `/admin/dashboard/operation-leads-stats?period=${period}`;
            if (period === 'custom' && startDate && endDate) {
                url += `&start_date=${startDate}&end_date=${endDate}`;
            } else if (period === 'monthly' && selectedPeriod) {
                url += `&selected_month=${selectedPeriod}`;
        ...
        function loadUsersData(filter) {
            ...
            let url = `/admin/dashboard/users-stats?filter=${filter}`;
        ...
        function viewUserDetails(userId) {
            ...
            // Fetch user details
            fetch(`/admin/dashboard/user-details/${userId}`)
                .then(response => {
                    if (!response.ok) {
                        throw new Error(`HTTP error! status: ${response.status}`);
                    }
        ...
        function loadTasksData() {
            ...
            fetch(`/admin/dashboard/tasks?${params}`)
                .then(response => response.json())
                .then(data => {
                    if (data.error) {
        ...
        function editTask(taskId) {
            fetch(`/admin/dashboard/tasks/${taskId}/edit`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function submitEditTaskForm() {
            ...
            fetch(`/admin/dashboard/tasks/${taskId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function loadTaskHistoryData() {
            ...
            fetch(`/admin/dashboard/task-history?${params}`)
                .then(response => response.json())
                .then(data => {
                    if (data.error) {
                        console.error('Error:', data.error);
        ...
        function loadCalendarDataAdmin() {
            ...
            fetch(`/admin/dashboard/calendar-data?year=${year}&month=${month}`, {
                headers: {
        ...
        function loadDateLeadsAdmin(dateStr) {
            ...
            fetch(`/admin/dashboard/calendar-leads?date=${dateStr}`, {
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
        ...
        function loadRevenueData(period, startDate = null, endDate = null, selectedPeriod = null) {
            ...
            let url = `/admin/dashboard/revenue-stats?period=${period}`;
            if (period === 'custom' && startDate && endDate) {
                url += `&start_date=${startDate}&end_date=${endDate}`;
            } else if (period === 'monthly' && selectedPeriod) {
                url += `&selected_month=${selectedPeriod}`;
            ...
            revenueDetails.forEach(detail => {
                ...
                tableHTML += `
                    <tr>
                        ...
                        <td>
                            <a href="/admin/operation-leads/${detail.lead_id}" class="btn action-btn view-btn" title="View Lead">
                                <i class="fas fa-eye"></i>
                            </a>
                        </td>
                    </tr>
        ...
        function loadPendingDeploymentsData() {
            ...
            fetch('/admin/dashboard/pending-deployments')
                .then(response => response.json())
                .then(data => {
        ...
        function loadOutstandingData(period, startDate, endDate, selectedPeriod) {
            ...
            let url = '/admin/dashboard/outstanding-amount-stats?period=' + period;
            ...
            outstandingDetails.forEach(detail => {
                ...
                tableHTML += `
                    <tr>
                        ...
                        <td>${receivedDate}</td>
                        <td>
                            <a href="/admin/operation-leads/${detail.operation_lead_id}" class="btn action-btn view-btn" title="View Lead">
                                <i class="fas fa-eye"></i>
                            </a>
                        </td>
                    </tr>
        ...
        function loadProfilePendingData(period, startDate, endDate, selectedPeriod) {
            ...
            let url = '/admin/dashboard/profile-pending-stats?period=' + period;
        ...
        function loadVendorPaymentData(period, startDate, endDate, selectedPeriod) {
            ...
            let url = '/admin/dashboard/vendor-payment-stats?period=' + period;
        ...
        function loadUnverifiedDeploymentData() {
            ...
            fetch('{{ route('admin.dashboard.unverified-deployment-payments-stats') }}')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
            ...
            data.deployments.forEach(deployment => {
                ...
                tableHTML += `
                    <tr>
                        ...
                        <td>
                            <a href="/admin/operation-leads/${deployment.lead_id}" class="btn action-btn view-btn" title="View Lead" target="_blank">
                                <i class="fas fa-eye"></i>
                            </a>
                        </td>
                    </tr>
        ...
        function toggleVerifyPaymentDashboard(deploymentId, isChecked) {
            ...
            $.ajax({
                url: `/admin/operation-leads/deployment/${deploymentId}/toggle-verify-payment`,
                type: 'POST',
                data: {
        ...
        function loadPendingCallbacksCount() {
            fetch('{{ route('admin.dashboard.pending-callbacks') }}')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-warning" style="text-transform: capitalize;">
                                    ${callback.call_status || 'N/A'}
                                </span>
                            </td>
                            <td>${responseDateTime}</td>
                            <td>
                                <a href="${viewUrl}" class="btn action-btn view-btn" title="View Lead" target="_blank">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </td>
                        </tr>
        ...
        function makeCallFromDashboard(customerNumber) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Reload the pending callbacks data after a short delay
                    setTimeout(() => {
                        loadPendingCallbacksData();
                        loadPendingCallbacksCount();
                    }, 2000);
        ...
        function updateRecentCallsDisplay(data) {
            ...
            container.querySelectorAll('.view-recording-btn').forEach(btn => {
        ...
        function openRecordingModal(recordingUrl, customerName, callDateTime) {
            console.log('Opening recording modal:', recordingUrl, customerName, callDateTime);
            ...
            if (!modal) {
                ...
                alert('Recording modal not found. Please refresh the page.');
                return;
            }

            // Set modal content
            const customerNameEl = document.getElementById('recordingCustomerName');
            const callDateTimeEl = document.getElementById('recordingCallDateTime');
            if (customerNameEl) customerNameEl.textContent = customerName || 'N/A';
            if (callDateTimeEl) callDateTimeEl.textContent = callDateTime || 'N/A';
        ...
        // Close modal when clicking outside
        document.addEventListener('click', function(event) {
            if (event.target && event.target.id === 'recordingModal') {
                closeRecordingModal();
            }
        });
