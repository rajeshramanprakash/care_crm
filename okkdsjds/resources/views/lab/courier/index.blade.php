...
<div class="modal fade" id="editCaseModal" tabindex="-1" aria-labelledby="editCaseModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="editCaseForm" action="{{route('lab.courier.case.update')}}" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="editCasePostModal" tabindex="-1" aria-labelledby="editCasePostModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="editCasePostModalForm"  action="{{route('lab.courier.case.update.post_one')}}" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="editCasePostTwoModal" tabindex="-1" aria-labelledby="editCasePostTwoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="editCasePostTwoModalForm" action="{{route('lab.courier.case.update.post_two')}}" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
...
<script>
    ...
    $('#clainNoForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ route('lab.cases.save-claimno') }}`,
            method: 'POST',
            data: formData,
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-view-case', function() {
            ...
            window.location.href = '/lab/cases/view/' + encryptedId;
        });
        ...
        function updateStatusCounts() {
            $.ajax({
                url: '{{ route("lab.courier.status-counts") }}',
                method: 'GET',
