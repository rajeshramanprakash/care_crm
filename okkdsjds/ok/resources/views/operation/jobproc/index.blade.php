...
<style>
    ...
    /* For all table cells except contact number */
    .table td, .table th {
    ...
    /* For contact number column: NO BREAKS */
    .contact-cell {
        min-width: 200px;
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="custom-table-scroll-x">
                        <table id="job-request-table" class="table">
                            <thead class="thead-light">
                                <tr>
                                    <th>Lead ID</th>
                                    <th>Date/Time</th>
                                    <th class="cell">Executive</th>
                                    <th>Customer</th>
            ...
            <div class="modal-body">
                <form id="addJobRequestForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="executive_id" name="executive_id" value="{{ $currentUser->id }}" required>
                        <input type="text" class="form-control" value="{{ $currentUser->name }}" readonly style="background-color: #f8f9fa;">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Lead ID:</strong> <span id="show_lead_id" class="badge badge-warning" style="font-size:1.1em;"></span></p>
            ...
            <div class="modal-body">
                <form id="editJobRequestForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="edit_executive_id" name="executive_id" required>
...
$(function() {
    var table = $('#job-request-table').DataTable({
        ...
        serverSide: false,
        ajax: {
            url: '{{ route('operation.jobproc.jobrequests') }}',
            data: function(d) {
        ...
        columns: [
            ...
            { data: 'executive', name: 'executive', className: 'cell',},
    ...
    $(document).on('click', '.show-job', function() {
        var id = $(this).data('id');
        $.get('{{ url('operation/jobproc') }}/' + id, function(data) {
    ...
    $(document).on('click', '.edit-job', function() {
        var id = $(this).data('id');
        $.get('{{ url('operation/jobproc') }}/' + id + '/edit', function(data) {
            $('#edit_id').val(data.id);
    ...
    $('#saveJobRequest').on('click', function() {
        // Form validation
        var requiredFields = ['customer_name', 'contact_no', 'name', 'age', 'gender', 'shift', 'job_title', 'city', 'status'];
        var missingFields = [];
        ...
        $.ajax({
            url: '{{ route('operation.jobproc.store') }}',
            type: 'POST',
            data: formData,
            success: function(response) {
                console.log('Success response:', response);
