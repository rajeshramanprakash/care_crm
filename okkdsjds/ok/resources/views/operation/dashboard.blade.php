...
<div id="recordingModal" class="modal-overlay">
    <div class="modal-content" style="max-width: 600px;">
        <div class="modal-header">
            ...
            <button class="modal-close" onclick="document.getElementById('recordingModal').style.display='none'">&times;</button>
        </div>
        <div class="modal-body">
...
<script>
                ...
                tableHTML += `
                    <tr>
                        ...
                        <td>
                            ...
                            <br><button onclick="makeCallFromDashboard('${callback.customer_number}')" class="btn btn-sm btn-success mt-1" title="Call Now">
    ...
    document.addEventListener('click', function(event) {
        if (event.target.classList.contains('modal-overlay')) {
            event.target.style.display = 'none';
            // Stop audio when closing recording modal
