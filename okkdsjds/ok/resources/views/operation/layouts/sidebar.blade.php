    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{route('operation.chat.index')}}" class="nav-link {{ strpos($route_name, 'chat') !== false ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('operation.jobproc.all_job_req.index') }}" class="nav-link {{ strpos($route_name, 'all_job_req') !== false ? 'active' : '' }}">
                        <i class="nav-icon fas fa-briefcase"></i>
                        <p>All Job Request</p>
                    </a>
                </li>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setInterval(updateSidebarUnreadBadgeOperation, 1000);
    });
</script>
