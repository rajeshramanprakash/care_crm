...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Duty Logs - {{ $user->f_name }} {{ $user->l_name }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('operation-manager.duty_logs.index') }}">Duty Logs</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Duty Activities for {{ $user->f_name }} {{ $user->l_name }}</h3>
                        </div>
                        <div class="card-body">
                            <div class="custom-table-scroll-x">
                                <table class="table table-bordered table-striped" id="user-duty-logs-table">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Status</th>
...
@section('footer-script')
    ...
    <script>
        $(document).ready(function() {
            $('#user-duty-logs-table').DataTable({
                responsive: true,
                order: [[0, 'desc']],
                pageLength: 25,
                scrollY: '50vh',
