                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="card-title m-0" style="font-size:14px; font-weight:600;">Staff List</h3>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center p-3" style="cursor: pointer;"
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        {{-- <small class="text-muted" style="font-size: 12px">{{ $staff->role->name }}</small> --}}
                                                    </div>
                                                    ...
                                                    <a href="#" class="list-group-item list-group-item-action chat-participant-link"
                                                       ...
                                                       data-participant-name="{{ $participant->f_name }} {{ $participant->l_name }}">
                                                        <div class="d-flex align-items-center" >
                                                            ...
                                                            <div class="ms-3 flex-grow-1">
                                                                <div class="d-flex justify-content-between align-items-center" >
                                                                    <h6 class="mb-0" style="font-size:12px; margin-left:10px;">{{ $participant->f_name }} {{ $participant->l_name }}</h6>
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <div class="last-message" style="margin-left:10px;">
                                                                        @if($participant->lastMessage)
...
@section('footer-script')
    ...
    <script>
        ...
        function loadMessages(salesId, participantId) {
            $.get(`{{ route('admin.staff.chats.messages', ['salesId' => ':salesId', 'participantId' => ':participantId']) }}`.replace(':salesId', salesId).replace(':participantId', participantId))
        ...
        function updateUnreadCounts() {
            $.get('{{ route('admin.staff.chats.unread-counts') }}')
        ...
        $(document).ready(function() {
            ...
            $('.chat-participant-link').click(function(e) {
                ...
                $.ajax({
                            url: `{{ route('admin.staff.chats.mark-read', ['userId' => ':userId']) }}`.replace(':userId', selectedParticipantId),
                    method: 'POST',
                    headers: {
