                ...
                <div class="modal-body">
                    <form id="addLeadForm">
                        ...
                        <div class="form-group mb-3" id="future_prospect_date_group" style="display: none;">
                            <label for="future_prospect_date" class="form-label">Future Contact Date</label>
                            <input type="date" class="form-control" id="future_prospect_date" name="future_prospect_date">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="mb-3" id="view_future_date_group">
                                <label class="fw-bold">Future Contact Date:</label>
                                <p id="view_future_prospect_date"></p>
                            </div>
                            <div class="mb-3" id="view_close_rate_group">
                                <label class="fw-bold">Rate:<image.pnglabel>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 'future prospect' && response.future_prospect_date) {
                            ...
                            $('#view_future_prospect_date').text(moment(response.future_prospect_date).format('DD-MM-YYYY'));
                        } else {
                        ...
                        // Filter recordings by emp_phone == Auth user's mobile
                        const authMobile = '{{ Auth::user()->mobile }}';
                        recordingsArr = recordingsArr.filter(function(rec) {
                            let meta = {};
                            try { meta = rec.metadata ? JSON.parse(rec.metadata) : {}; } catch(e) {}
                            return meta.emp_phone == authMobile;
                        });
