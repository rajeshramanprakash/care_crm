...
<div class="content-wrapper pb-5 pt-4">
    <section class="content">
        ...
        <div class="card mb-3">
            <div class="card-header text-light" style="background-color: var(--wb-renosand);">
                <h3 class="card-title">Add OPD Attachment For Post One Case (if already added do not many changes)</h3>
                @if ($case->is_post_2 != 1)
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <span class="text-bold mx-1" style="color: var(--wb-wood)">OPD Attachment: </span>
        ...
        <div class="card mb-3">
            <div class="card-header text-light" style="background-color: var(--wb-renosand);">
                <h3 class="card-title">Add OPD Attachment For Post Two Case (if already added do not many changes)</h3>
                <button href="javascript:void(0);" class="btn p-0 text-light float-right" title="Edit Post Case info."
