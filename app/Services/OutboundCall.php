...
class OutboundCall
{
    ...
    public static function call($customerNumber, $refId = null, $user = null, ?string $executiveNumberOverride = null)
    {
        $instance = new static();
        ...
        $executiveNumber = $executiveNumberOverride ?: $currentUser->mobile;
     ...
     */
    protected function makeTataClickToCall($executiveNumber, $customerNumber, $refId = null, $user = null, ?string $agentNumber = null)
    {
        try {
            ...
            $requestData = [
                'agent_number' => $agentNumber ?: $executiveNumber,
            ...
            $clickToCallUrl = ApiRelayUrlResolver::resolve('https://api-smartflo.tatateleservices.com/v1/click_to_call');
            ...
            ])->post($clickToCallUrl, $requestData);
