...
class VendorController extends Controller
{
    public function index()
    {
        ...
        return view('admin.vendor.index', compact('vendors', 'services', 'locations', 'pendingPriceChangeCount', 'pendingByVendor'));
    }
    ...
    private function formatVendorForJson(Vendor $vendor): array
    {
        ...
        $data['leegality_html'] = view('admin.vendors.partials.leegality_agreement_panel', [
            'vendor' => $vendor,
