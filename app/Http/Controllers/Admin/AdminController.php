        ...
        try {
            ...
            foreach ($callLogs as $callLog) {
                ...
                if ($callFor === 'operation_lead' && $operationLead) {
                    ...
                    $viewUrl = route('admin.operation_leads.show', $operationLead->id);
                    ...
                    $viewUrl = route('admin.leads.show', $lead->id);
                    $relatedId = $lead->id;
        ...
        try {
            ...
            foreach ($callLogs as $callLog) {
                ...
                $recentCalls[] = [
                    ...
                    'duration' => $callLog->call_duration ? gmdate('H:i:s', $callLog->call_duration) : 'N/A',
                    'call_log_id' => $callLog->id,
                    'view_url' => $lead ? route('admin.leads.show', $lead->id) : null,
            ...
            foreach ($callLogs as $callLog) {
                ...
                if ($callLog->call_for === 'operation_lead') {
                    ...
                    if ($lead) {
                        ...
                        $viewUrl = route('admin.operation_leads.show', $lead->id);
                        $relatedId = $lead->id;
                    }
