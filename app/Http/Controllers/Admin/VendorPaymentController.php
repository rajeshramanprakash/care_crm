...
class VendorPaymentController extends Controller
{
    ...
    public function statementApi($vendorId)
    {
        ...
        $html = view('admin.vendor_payments.statement', compact(
            'vendor',
            'statementRows',
            'totalEarned',
            'totalPaid',
    ...
    public function invoice($id)
    {
        ...
        return view('admin.vendor_payments.invoice', compact('payment', 'lineItems', 'balanceAmount', 'balanceBeforeThisPayment'));
    }
    ...
    public function invoiceApi($id)
    {
        ...
        $html = view('admin.vendor_payments.invoice', compact('payment', 'lineItems', 'balanceAmount', 'balanceBeforeThisPayment', 'forApp', 'logoBase64'))->render();
        return response($html, 200, [
            'Content-Type' => 'text/html; charset=UTF-8',
        ]);
    }
