...
class SubAdminDoctorConsultationServiceController extends Controller
{
    public function index()
    {
        ...
        return view('subadmin.doctor_consultation_services.index', compact('items'));
    }

    public function create()
    {
        return view('subadmin.doctor_consultation_services.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('subadmin.doctor_consultation_services.index')
    ...
    public function edit(DoctorConsultationService $doctor_consultation_service)
    {
        ...
        return view('subadmin.doctor_consultation_services.edit', ['item' => $doctor_consultation_service]);
    }
