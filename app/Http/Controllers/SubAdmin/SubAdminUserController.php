...
class SubAdminUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('subadmin.users.index', compact('page_heading', 'roles', 'locations'));
    }
    ...
    public function manage($id = null)
    {
        ...
        return view('subadmin.users.manage', compact('user', 'roles', 'locations', 'parentUsers', 'lead_types', 'services', 'permissions'));
    }
    ...
    public function manage_process(Request $request, $id = null)
    {
        ...
        return redirect()->route('subadmin.users.index')->with('status', [
            'alert_type' => 'success',
            'message' => $message,
        ]);
    }
