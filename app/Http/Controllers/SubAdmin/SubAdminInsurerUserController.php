...
class SubAdminInsurerUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('subadmin.insurers.index', [
            'items' => $items,
    ...
    {
        return view('subadmin.insurers.form', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('subadmin.insurers.index')->with('success', 'Insurer account created. They can login with the username and password you set.');
    }
    ...
    public function update(Request $request, InsurerUser $insurer)
    {
        ...
        return redirect()->route('subadmin.insurers.index')->with('success', 'Insurer account updated.');
    }
    ...
    public function destroy(InsurerUser $insurer)
    {
        ...
        return redirect()->route('subadmin.insurers.index')->with('success', 'Insurer account removed.');
    }
}
