...
class SubAdminServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('subadmin.services.index', compact('services'));
    }

    public function create()
    {
        return view('subadmin.services.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('subadmin.services.index')
    ...
    public function edit(Service $service)
    {
        ...
        return view('subadmin.services.edit', ['item' => $service]);
    }
