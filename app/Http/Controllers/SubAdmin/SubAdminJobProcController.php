...
class SubAdminJobProcController extends Controller
{
    public function index() {
        ...
        return view('subadmin.jobproc.index', compact('executives', 'locations', 'services', 'pendingPriceChangeCount'));
    }
    ...
    public function show($id)
    {
        ...
        $leegalityHtml = view('subadmin.jobproc.partials.leegality_agreement_panel', [
        ...
        return response()->json([
            ...
            'profile_image_generate_url' => $hasUniformProfile
                ? route('subadmin.jobproc.profile_image_generate', $jobRequest)
                : null,
            'profile_image_approve_url' => $hasUniformProfile
                ? route('subadmin.jobproc.profile_image_approve', $jobRequest)
                : null,
        ]);
    }
