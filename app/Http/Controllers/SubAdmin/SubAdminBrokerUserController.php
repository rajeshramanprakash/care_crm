...
class SubAdminBrokerUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('subadmin.brokers.index', [
            'items' => $items,
    ...
    {
        return view('subadmin.brokers.form', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('subadmin.brokers.index')->with('success', 'Broker account created. They can login with the username and password you set.');
    }
    ...
    public function update(Request $request, BrokerUser $broker)
    {
        ...
        return redirect()->route('subadmin.brokers.index')->with('success', 'Broker account updated.');
    }
    ...
    public function destroy(BrokerUser $broker)
    {
        ...
        return redirect()->route('subadmin.brokers.index')->with('success', 'Broker account removed.');
    }
}
