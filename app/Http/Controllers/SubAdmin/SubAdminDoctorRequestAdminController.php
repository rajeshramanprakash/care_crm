...
class SubAdminDoctorRequestAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('subadmin.doctor_requests.index', compact(
            'doctorReferralUsers',
    ...
    public function show(DoctorRequest $doctor_request)
    {
        ...
        return view('subadmin.doctor_requests.show', [
    ...
    public function viewModal(DoctorRequest $doctor_request)
    {
        ...
        return view('subadmin.doctor_requests.partials.registration_detail_card', [
            'doctor' => $doctor_request,
            'doctorReferralUsers' => $doctorReferralUsers,
            'showCareWebReviewsAdminTools' => true,
            'showRegistrationProfileEditor' => true,
    ...
    public function data(Request $request)
    {
        ...
        $data = $q->withCount([
            ...
            return [
                ...
                'actions' => view('subadmin.doctor_requests._actions', ['row' => $row])->render(),
            ];
        });
    ...
    public function websiteReviewsPanel(DoctorRequest $doctor_request): \Illuminate\Contracts\View\View
    {
        ...
        return view('subadmin.doctor_requests.partials.website_reviews_manage', [
            'doctor' => $doctor_request,
        ]);
    }
    ...
    public function websiteReviewsStore(Request $request, DoctorRequest $doctor_request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'html' => view('subadmin.doctor_requests.partials.website_reviews_manage', [
                'doctor' => $doctor_request,
            ])->render(),
        ]);
    }
    ...
    public function updatePortalLeadCommission(Request $request)
    {
        ...
        return redirect()
            ->route('subadmin.doctor_requests.index')
            ->with('status', [
                'alert_type' => 'success',
