...
class SubAdminOperationLeadController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('subadmin.operation_leads.index', compact('vendors', 'executives', 'locations', 'services'));
    }
    ...
    public function show($id)
    {
        ...
        return view('subadmin.operation_leads.show', compact('lead', 'paymentInvoices', 'receivedPayments', 'vendors', 'filteredVendors', 'services', 'deploymentDetails', 'crm_lead', 'crmLeadStatusRemarks', 'operationStatusRemarks', 'locations', 'executives', 'b2bCorporateLead'));
    }
    ...
    public function showPaymentInvoice($id)
    {
        ...
        return view('subadmin.operation_leads.payment_invoice_show', compact('invoice', 'totalReceived', 'status'));
    }
    ...
    public function showPaymentInvoiceHtml($id)
    {
        ...
        $forApp = true;
        $html = view('subadmin.operation_leads.payment_invoice_show', compact('invoice', 'totalReceived', 'status', 'forApp'))->render();
