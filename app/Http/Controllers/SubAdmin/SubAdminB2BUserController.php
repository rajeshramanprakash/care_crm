...
class SubAdminB2BUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('subadmin.b2b_users.index', compact('page_heading', 'items', 'serviceOptions', 'referenceUsers', 'referenceUserRecords'));
    }
