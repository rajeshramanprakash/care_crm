...
class SubAdminFreelancerPaymentController extends Controller
{
    public function index()
    {
        ...
        return view('subadmin.freelancer_payments.index', compact('freelancers'));
    }
    ...
    public function statement($freelancerId)
    {
        ...
        return view('subadmin.freelancer_payments.statement', compact(
            'freelancer',
            'statementRows',
            'totalEarned',
            'totalPaid',
    ...
    public function statementApi($freelancerId)
    {
        ...
        $html = view('subadmin.freelancer_payments.statement', compact(
            'freelancer',
            'statementRows',
            'totalEarned',
            'totalPaid',
    ...
    public function invoice($id)
    {
        ...
        return view('subadmin.freelancer_payments.invoice', compact(
            'payment',
            'lineItems',
            'balanceAmount',
    ...
    public function invoiceApi($id)
    {
        ...
        $html = view('subadmin.freelancer_payments.invoice', compact(
            'payment',
            'lineItems',
            'balanceAmount',
            'balanceBeforeThisPayment',
