...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\ForceAuthHeader::class,
    ];
    ...
    protected $middlewareAliases = [
        ...
        'broker.auth' => \App\Http\Middleware\BrokerAuthMiddleware::class,
        'corporate.auth' => \App\Http\Middleware\CorporateAuthMiddleware::class,
        'corporate.employee.auth' => \App\Http\Middleware\CorporateEmployeeAuthMiddleware::class,
        'VendorWalletCheck' => \App\Http\Middleware\VendorWalletCheck::class,
        'careweb.key' => \App\Http\Middleware\EnsureCarewebKey::class,
    ];
}
