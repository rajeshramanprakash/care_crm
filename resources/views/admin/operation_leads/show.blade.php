                                        ...
                                        <tbody>
                                            @forelse($paymentInvoices as $invoice)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.operation_leads.payment_invoice.show', $invoice->id) }}" target="_blank" class="btn btn-sm btn-info" title="View Invoice">
...
@section('footer-script')
    ...
    <script>
        ...
        function openAbsentDatesModal(deploymentId) {
            ...
            fetch(`{{ route('admin.operation_leads.deployment.dates', ['id' => 'DEP_ID_PLACEHOLDER']) }}`.replace('DEP_ID_PLACEHOLDER', deploymentId), {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}',
        ...
        function saveAbsentDates(deploymentId) {
            ...
            fetch(`{{ route('admin.operation_leads.deployment.save-absent', ['id' => 'DEP_ID_PLACEHOLDER']) }}`.replace('DEP_ID_PLACEHOLDER', deploymentId), {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}',
                    'Accept': 'application/json',
