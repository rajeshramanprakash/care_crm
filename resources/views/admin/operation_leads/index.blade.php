...
$(function() {
    ...
    var table = $('#operation-leads-table').DataTable({
        ...
        serverSide: true,
        ajax: {
                    url: '{{ route('admin.operation_leads.getLeads') }}',
                    data: function(d) {
                ...
                render: function(data, type, row) {
                    return `
                        <div class="btn-group" role="group">
                            <a href="/admin/operation-leads/${row.id}" class="btn action-btn view-btn" data-id="${row.id}" title="View">
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $.get('/admin/operation-leads/' + leadId + '/edit', function(lead) {
    ...
    $('#updateOperationLead').on('click', function() {
        ...
        $.ajax({
            url: '/admin/operation-leads/' + leadId,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
$(document).on('click', '.vendor-count-btn', function() {
    ...
    $.ajax({
        url: '/admin/operation-leads/vendor-details',
        type: 'GET',
        data: {
            lead_id: leadId,
            location: location,
...
function updateFreelancerStatus(freelancerId, status) {
    ...
    $.ajax({
        url: '/admin/operation-leads/update-freelancer-status',
        type: 'POST',
        data: {
...
function updateVendorCountInTable() {
    ...
    $('.vendor-count-btn').each(function() {
        ...
        $.ajax({
            url: '/admin/operation-leads/updated-vendor-count',
            type: 'GET',
            data: {
                lead_id: leadId,
                location: location,
