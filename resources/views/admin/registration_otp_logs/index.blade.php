...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Verify No. — {{ $registrationLabel }}</h1>
                    <p class="text-muted mb-0 small">{{ $registrationLabel }} registration — Contact No OTP sent / verified (timestamp &amp; IP)</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <form method="get" action="{{ route($indexRoute) }}" class="form-inline flex-wrap gap-2">
                        ...
                        <a href="{{ route($indexRoute) }}" class="btn btn-sm btn-secondary mb-1">Reset</a>
                    </form>
                </div>
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover table-striped mb-0 otp-log-table">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="12" class="text-center text-muted py-4">No OTP logs yet. They appear when {{ strtolower($registrationLabel) }}s use Send OTP on the registration form.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
