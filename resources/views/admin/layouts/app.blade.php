...
<style>
  ...
  font-style: normal;
    ...
    /* Body stays fixed; main content area scrolls (languages translations, long forms, etc.) */
    ...
    body.sidebar-mini.layout-fixed .wrapper > .content-wrapper {
        ...
        scrollbar-color: #fd7e14 #f1f1f1;
    }
    body.sidebar-mini.layout-fixed .wrapper > .content-wrapper::-webkit-scrollbar {
        width: 8px;
    }
    body.sidebar-mini.layout-fixed .wrapper > .content-wrapper::-webkit-scrollbar-track {
        background: #f1f1f1;
        border-radius: 10px;
    }
    body.sidebar-mini.layout-fixed .wrapper > .content-wrapper::-webkit-scrollbar-thumb {
        background: #fd7e14;
        border-radius: 10px;
    }
    .main-footer {
...
<body class="sidebar-mini layout-fixed" style="overflow: hidden">
    ...
    <script>
        // Fix for AdminLTE tree plugin - map .tree() to .Treeview() immediately after AdminLTE loads
        (function() {
            if (typeof jQuery !== 'undefined' && typeof jQuery.fn !== 'undefined') {
                if (typeof jQuery.fn.Treeview !== 'undefined' && typeof jQuery.fn.tree === 'undefined') {
                    jQuery.fn.tree = function(options) {
                        return this.Treeview(options);
                    };
                }
            }
        })();
...
$(document).ready(function() {
    ...
    setTimeout(function() {
        ...
        // After Apply: close filter drawer (runs after page #filters-form handlers bubble)
