        ...
        <div>
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.payments.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.payments.') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-link"></i>
                            <p>Payments</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('admin.leads.index')}}" class="nav-link {{ str_starts_with($route_name, 'admin.leads.') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-user-friends"></i>
                            <p>Leads</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.referral_leads.index') }}" class="nav-link {{ strpos($route_name, 'referral_leads') !== false ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.b2b_users.index')}}" class="nav-link {{ strpos($route_name, 'b2b_users') !== false ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-treeview {{ $ci_b2b_open ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.corporate_individual.hub') }}" class="nav-link {{ strpos($route_name, 'corporate_individual') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Hub</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.b2b_corporate.index') }}" class="nav-link {{ strpos($route_name, 'b2b_corporate') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>B2B Corporate</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.b2b_individual.index') }}" class="nav-link {{ strpos($route_name, 'b2b_individual') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Individual</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview {{ $insurer_broker_sidebar_open ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.insurers.index') }}" class="nav-link {{ strpos($route_name, 'insurers') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Insurers</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.brokers.index') }}" class="nav-link {{ strpos($route_name, 'brokers') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Brokers</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.corporate-accounts.index') }}" class="nav-link {{ strpos($route_name, 'corporate-accounts') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Corporate Accounts</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.corporate-employees.index') }}" class="nav-link {{ strpos($route_name, 'corporate-employees') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item has-treeview {{ $doctor_sidebar_open ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.doctor_registration_otp_logs.index') }}" class="nav-link {{ strpos($route_name, 'doctor_registration_otp_logs') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Verify No.</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.doctor_requests.index') }}" class="nav-link {{ strpos($route_name, 'doctor_requests') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Doctor requests</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.doctor_consultation_services.index') }}" class="nav-link {{ strpos($route_name, 'doctor_consultation_services') !== false ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item has-treeview {{ $freelancer_vendor_sidebar_open ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.vendor_registration_otp_logs.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.vendor_registration_otp_logs') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Vendor Verify No.</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.vendors.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.vendors.') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Vendor</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.vendor_payments.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.vendor_payments.') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Vendor Payments</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.freelancer_registration_otp_logs.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.freelancer_registration_otp_logs') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Freelancer Verify No.</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.freelancer_payments.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.freelancer_payments.') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Freelancer Payments</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.location_attendance.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.location_attendance.') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Freelancer &amp; Vendor Attendance</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.jobproc.index') }}" class="nav-link {{ str_starts_with($route_name, 'admin.jobproc.') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Job Request</p>
                                </a>
                            </li>
