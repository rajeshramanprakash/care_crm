        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <form method="get" action="{{ route('admin.doctor_registration_otp_logs.index') }}" class="form-inline flex-wrap gap-2">
                        ...
                        <a href="{{ route('admin.doctor_registration_otp_logs.index') }}" class="btn btn-sm btn-secondary mb-1">Reset</a>
                    </form>
                </div>
