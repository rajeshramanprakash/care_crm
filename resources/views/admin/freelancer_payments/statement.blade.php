...
<head>
    ...
    <title>Freelancer Statement – {{ $freelancer->name ?? 'N/A' }}</title>
    <style>
...
<body>
    ...
    <div class="mid-section">
        <div class="to-block">
            ...
            <div class="to-line"><strong>Name:</strong> {{ $freelancer->name ?? 'N/A' }}</div>
            <div class="to-line"><strong>ID:</strong> {{ $freelancer->id ?? '—' }}</div>
            <div class="to-line"><strong>Phone:</strong> {{ $freelancer->contact_no ?? '—' }}</div>
        </div>
        <div class="title-block">
            <h2 class="doc-title">Freelancer Statement</h2>
