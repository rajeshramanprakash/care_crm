...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('admin.freelancer_payments.index') }}" class="btn btn-outline-primary">
...
$(document).ready(function() {
    ...
    $('#addPaymentForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("admin.freelancer_payments.store") }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#editPaymentForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `/admin/freelancer-payments/${paymentId}`,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
function viewFreelancerHistory(freelancerId, freelancerName) {
    ...
    $.ajax({
        url: `/admin/freelancer-payments/freelancer/${freelancerId}`,
        type: 'GET',
        success: function(response) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a href="/admin/freelancer-payments/${payment.id}/invoice?print=1" target="_blank" class="btn btn-outline-danger btn-sm" title="Download PDF"><i class="fas fa-file-pdf"></i></a>
                                </div>
                            </td>
                            <td>
                                <div class="btn-group btn-group-sm">
...
function addFreelancerPayment(freelancerId, freelancerName) {
    ...
    fetch(`/admin/operation-leads/freelancer-payment-details/${freelancerId}`)
        .then(r => r.json())
        .then(data => {
...
function viewPayment(id) {
    $.get(`/admin/freelancer-payments/${id}`, function(response) {
...
function editPayment(id) {
    ...
    $.get(`/admin/freelancer-payments/${id}/edit`, function(response) {
...
function deletePayment(id) {
    ...
    $.ajax({
        url: `/admin/freelancer-payments/${id}`,
        type: 'DELETE',
        headers: {
...
function viewInvoice(paymentId) {
    document.getElementById('invoiceFrame').src = '/admin/freelancer-payments/' + paymentId + '/invoice';
...
function viewFreelancerStatement(freelancerId, freelancerName) {
    const statementUrl = '{{ route("admin.freelancer_payments.statement", ["freelancerId" => "__FID__"]) }}'.replace('__FID__', freelancerId);
...
function refreshFreelancerStats(freelancerId) {
    $.get(`/admin/freelancer-payments/freelancer/${freelancerId}`, function(response) {
