                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if($insurerEmployeeTotal > 0)
                                                <a href="{{ route('admin.corporate-accounts.index', ['insurer_id' => $item->id]) }}" class="btn btn-sm btn-outline-success py-0 px-2" title="View corporates & employees for this insurer">{{ $insurerEmployeeTotal }}</a>
                                            @else
                                                <span class="text-muted">0</span>
                                            @endif
                                        </td>
