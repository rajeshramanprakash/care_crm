            ...
            <div class="card-body">
                @if(request('broker_id') || request('insurer_id'))
                    <div class="alert alert-info py-2 small">
                        ...
                        <a href="{{ route('admin.corporate-accounts.index') }}">Show all</a>
                    </div>
                @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($item->employees_count > 0)
                                            <a href="{{ route('admin.corporate-employees.index', ['corporate_id' => $item->id]) }}" class="btn btn-sm btn-outline-primary py-0 px-2" title="View employees">
                                    ...
                                    <td>
                                        @if($item->employees_count > 0)
                                            <a href="{{ route('admin.corporate-employees.index', ['corporate_id' => $item->id]) }}" class="btn btn-sm btn-info">View employees</a>
                                        @endif
                                    </td>
                                </tr>
                            @empty
