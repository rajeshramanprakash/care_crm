    ...
    <div class="container-fluid py-3">
        <div class="card dcs-table-card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.doctor_consultation_services.create') }}" class="btn btn-light btn-sm font-weight-bold">
            ...
            <div class="card-body">
                ...
                @if($items->isEmpty())
                    <div class="dcs-empty">
                        ...
                        <a href="{{ route('admin.doctor_consultation_services.create') }}" class="btn btn-dcs-primary">
                            ...
                            <tbody>
                                @foreach($items as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.doctor_consultation_services.edit', $row) }}" class="btn btn-sm btn-outline-primary rounded-circle mr-1" title="Edit">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <form action="{{ route('admin.doctor_consultation_services.destroy', $row) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
