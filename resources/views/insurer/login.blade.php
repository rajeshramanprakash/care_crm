...
<head>
    ...
    <title>Insurer Login - Carelix</title>
...
<div class="contain">
    <div class="left">
        ...
        <h2 style="margin-top: 24px; text-align: center;">Insurer Portal</h2>
    ...
    <div class="right">
        <div class="login-box">
            <div class="login-title">Insurer Login</div>
            ...
            <form method="POST" action="{{ route('insurer.login.submit') }}">
                @csrf
