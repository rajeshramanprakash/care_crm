...
<head>
    ...
    <title>Corporate Login - Carelix</title>
...
<div class="contain">
    <div class="left">
        ...
        <h2 style="margin-top: 24px; text-align: center;">Corporate Portal</h2>
        <p style="text-align: center; max-width: 360px; line-height: 1.6; opacity: 0.95;">Sign in with the username and password provided by your insurer or broker.</p>
    </div>
    <div class="right">
        <div class="login-box">
