        ...
        <div class="container-fluid pt-3">
            <div class="card srl-card">
                <div class="card-header srl-header d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <button type="button" class="btn btn-warning text-dark font-weight-bold mt-2 mt-md-0" id="openSalesGenerateLeadModalBtn" data-bs-toggle="modal" data-bs-target="#salesGenerateLeadModal">
...
<div class="modal fade" id="salesGenerateLeadModal" tabindex="-1" aria-labelledby="salesGenerateLeadModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content srl-modal-content">
            <div class="modal-header srl-modal-header">
                <h5 class="modal-title font-weight-bold" id="salesGenerateLeadModalLabel">
                    <i class="fas fa-plus mr-2" style="color:#F07F28"></i>Generate Lead
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{ route('sales.referral_leads.store') }}" id="salesGenerateLeadForm">
                    @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var modalEl = document.getElementById('salesGenerateLeadModal');
        if (!modalEl || typeof bootstrap === 'undefined' || !bootstrap.Modal) return;

        var modal = bootstrap.Modal.getOrCreateInstance(modalEl);
        var openBtn = document.getElementById('openSalesGenerateLeadModalBtn');
        if (openBtn) {
