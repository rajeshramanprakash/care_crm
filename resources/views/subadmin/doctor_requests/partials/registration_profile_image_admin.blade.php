...
<div class="dr-profile-image-admin border rounded p-3 mt-3 bg-white"
     ...
     data-generate-url="{{ route('subadmin.doctor_requests.profile_image_generate', $doctor) }}"
     data-approve-url="{{ route('subadmin.doctor_requests.profile_image_approve', $doctor) }}">
