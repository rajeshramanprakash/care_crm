                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-5 text-right">
                            <a href="{{ route('subadmin.locations.bulk-template') }}" class="btn btn-outline-secondary btn-sm">
...
<div class="modal fade" id="bulkUploadModal" tabindex="-1" aria-labelledby="bulkUploadModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('subadmin.locations.bulk-import') }}" method="POST" enctype="multipart/form-data" id="bulkUploadForm">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="text-center mb-3">
                        <a href="{{ route('subadmin.locations.bulk-template') }}" class="btn btn-outline-primary btn-sm">
