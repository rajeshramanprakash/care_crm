        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb-2 align-items-center flex-wrap">
                <div class="d-flex flex-wrap mb-3">
                    ...
                    <a href="{{ route('subadmin.break_logs.index') }}" class="btn btn-info">
    ...
    <script>
        ...
        $(function() {
            var table = $('#serverTable').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('subadmin.users.getUsers') }}",
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (canEditUser) html += `<a href="/subadmin/users/manage/${row.id}" class="btn btn-primary" title="Edit"><i class="fas fa-edit"></i></a>`;
                            if (canViewUser) html += `<a href="/subadmin/break-logs/user/${row.id}" class="btn btn-info" title="Break Logs"><i class="fas fa-clock"></i></a>`;
                            if (canViewUser) html += `<a href="/subadmin/duty-logs/user/${row.id}" class="btn btn-success" title="Duty Logs"><i class="fas fa-user-check"></i></a>`;
            ...
            $(document).on('click', '.delete-btn', function() {
                if (confirm('Are you sure you want to delete this user?')) {
                    ...
                    $.ajax({
                        url: "{{ route('subadmin.users.destroy', '') }}/" + userId,
                        type: 'get',
                        headers: {
