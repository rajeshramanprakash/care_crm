                                            ...
                                            <tr>
                                                ...
                                                <td class="b2b-actions-cell align-middle">
                                                    <div class="b2b-actions">
                                                        ...
                                                        <form method="POST" action="{{ route('subadmin.b2b_users.destroy', $item) }}" class="d-inline m-0" onsubmit="return confirm('Delete this B2B user? All leads they created in the B2B portal will be permanently removed.');">
                                                            @csrf
                                                            @method('DELETE')
                                            ...
                                            <div class="modal fade" id="editB2BUserModal{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-xl" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST" action="{{ route('subadmin.b2b_users.update', $item->id) }}" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="form-row">
                                    ...
                                    <tbody>
                                        @forelse($referenceUserRecords as $ref)
                                            <tr>
                                                ...
                                                <td class="b2b-actions-cell align-middle">
                                                    <div class="b2b-actions">
                                                        <form method="POST" action="{{ route('subadmin.b2b_reference_users.destroy', $ref) }}" class="d-inline m-0" onsubmit="return confirm('Delete this reference user? Linked B2B companies will lose their referral assignment.');">
                                                            @csrf
                                                            @method('DELETE')
            ...
            <div class="modal fade" id="createB2BReferenceUserModal" tabindex="-1" role="dialog" aria-labelledby="createB2BReferenceUserModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content rounded-lg overflow-hidden border-0 shadow">
                        ...
                        <form method="POST" action="{{ route('subadmin.b2b_reference_users.store') }}">
                            @csrf
            ...
            <div class="modal fade" id="createB2BUserModal" tabindex="-1" role="dialog" aria-labelledby="createB2BUserModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content rounded-lg border-0 shadow">
                        ...
                        <form method="POST" action="{{ route('subadmin.b2b_users.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
