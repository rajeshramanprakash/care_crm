...
@section('header-css')
    ...
    <style>
        ...
        /* Sticky header and scrollable tbody */
        .custom-table-scroll-x table thead {
            position: sticky;
            top: 0;
            background: #fff;
            z-index: 2;
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Break Activities</h3>
                        </div>
                        <div class="card-body">
                            <div class="custom-table-scroll-x">
                                <table class="table table-bordered table-striped" id="break-logs-table">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>User</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $log->id }}</td>
                                            <td>
                                                <a href="{{ route('subadmin.break_logs.user', $log->user_id) }}">
