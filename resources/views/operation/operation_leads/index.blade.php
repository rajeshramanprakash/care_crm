...
@section('header-css')
    ...
    <style>
        ...
        .table.dataTable thead th,
        .custom-table-scroll-x .dataTables_scrollHead thead th {
        ...
        /* Scroll area: single normal table so header/body columns stay aligned */
        ...
        .custom-table-scroll-x table thead th {
            position: sticky;
            top: 0;
            z-index: 3;
            box-shadow: 0 1px 0 #f0f0f0;
        }
        /* Column width hints (fixed layout) — long text wraps inside cell */
        #operation-leads-table thead th:nth-child(1) { width: 9%; }
        #operation-leads-table thead th:nth-child(2) { width: 10%; }
        #operation-leads-table thead th:nth-child(3) { width: 7%; }
        #operation-leads-table thead th:nth-child(4) { width: 14%; }
        #operation-leads-table thead th:nth-child(5) { width: 11%; }
        #operation-leads-table thead th:nth-child(6) { width: 7%; }
        #operation-leads-table thead th:nth-child(7) { width: 9%; }
        #operation-leads-table thead th:nth-child(8) { width: 9%; }
        #operation-leads-table thead th:nth-child(9) { width: 6%; }
        #operation-leads-table thead th:nth-child(10) { width: 12%; }
        #operation-leads-table thead th:nth-child(11) { width: 6%; }
        #operation-leads-table thead th:nth-child(12) { width: 5%; }
        #operation-leads-table thead th:nth-child(13) { width: 5%; }

        /* DataTables scrollX: two synced tables — same widths + wrap in body */
        .custom-table-scroll-x .dataTables_scrollHead table,
        .custom-table-scroll-x .dataTables_scrollBody table {
            table-layout: fixed !important;
            width: 100% !important;
            min-width: 1280px;
        }
        .custom-table-scroll-x .dataTables_scrollBody td {
        ...
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(1) { width: 9%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(2) { width: 10%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(3) { width: 7%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(4) { width: 14%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(5) { width: 11%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(6) { width: 7%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(7) { width: 9%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(8) { width: 9%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(9) { width: 6%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(10) { width: 12%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(11) { width: 6%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(12) { width: 5%; }
        .custom-table-scroll-x .dataTables_scrollHead thead th:nth-child(13) { width: 5%; }

        /* Contact No: keep phone + icons on one line */
        .contact-cell {
            min-width: 0;
        ...
        /* Contact cell: number on first line, icons below */
        .contact-wrap {
            display: flex;
        ...
        /* Text columns: wrap within column width (table-layout: fixed supplies width) */
        .customer-cell {
        ...
        /* Status & Query Badge Styling — wrap long labels inside narrow columns */
        .status-badge {
            border-radius: 8px;
            font-size: 0.85rem;
            font-weight: 500;
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group mb-3 d-none" id="future_prospect_date_group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="future_prospect_date" name="future_prospect_date" step="60"
                                        ...
                                        title="Must be after now — for 05:32 next morning, choose tomorrow’s date">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                @include('partials.lead-status-remarks-fields', [
                                    'fieldPrefix' => 'edit',
                                    'aiGenerateUrlTemplate' => url('/operation/operation-leads/__ID__/status-remark/generate-ai'),
                                ])
                            </div>
                        </div>
                    </form>
                                        ...
                                        @foreach ($locations as $location)
                                            <div class="custom-control custom-checkbox my-1">
                                                ...
                                                <label for="team_member_{{ $location->name }}"
                                                    class="custom-control-label">{{ $location->display_label }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                ...
                columns: [{
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="contact-wrap">
                                    <div class="contact-number">${data}</div>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return `<span style="color: #000; font-weight: 500;">${display}</span>`;
                        }
                    },
                    {
                        data: 'vendor_name',
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $.get('{{ url("operation/operation-leads") }}/' + leadId + '/edit', function(lead) {
                    ...
                    for (const [key, value] of Object.entries(lead)) {
                        ...
                        if (key === 'query') {
                            ...
                            var fpVal = formatOpFpForInput(value);
                            ...
                            var fuVal = formatOpFpForInput(value);
                ...
                <div class='col-12 mb-3'>
                    <div class='alert alert-info'>
                        ...
                        ${lead.status === 'follow up' ? ` | <strong>Follow-up date & time:</strong> ${formatOpFpDisplay(lead.follow_up_date)}` : ''}
                        ${lead.status === 'future prospect' ? ` | <strong>Future contact date & time:</strong> ${formatOpFpDisplay(lead.future_prospect_date)}` : ''}
                    </div>
                </div>
            ` + fields;
