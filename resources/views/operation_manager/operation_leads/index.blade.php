    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $.get('/operation-manager/operation-leads/' + leadId + '/edit', function(lead) {
            ...
            const editableFields = [
                'query', 'query_remark', 'status', 'follow_up_date', 'future_prospect_date', 'shift_type', 'price_issue_remark', 'inactive_remark', 'closed_remark', 'patient_name', 'age', 'closed_rate', 'executive'
            ];
            ...
            for (const [key, value] of Object.entries(lead)) {
                ...
                if (key === 'query') {
                    ...
                    var fpVal = value ? moment(value).format('YYYY-MM-DDTHH:mm') : '';
                    ...
                    var fuVal = value ? moment(value).format('YYYY-MM-DDTHH:mm') : '';
            ...
            fields = `
                <div class='col-12 mb-3'>
                    <div class='alert alert-info'>
                        ...
                        ${lead.status === 'follow up' ? ` | <strong>Follow-up date & time:</strong> ${lead.follow_up_date ? moment(lead.follow_up_date).format('DD-MM-YYYY HH:mm') : 'N/A'}` : ''}
