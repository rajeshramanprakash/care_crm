    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="form_title_modal" style="color: #000 !important"></h4>
    ...
    $("#sendMessageBtnHi").click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    // Append "Hi" message to chat
                    const now = new Date();
                    const msgHtml = `
                        <div class="card-send">
                            <div class="whatsapp-card-send">
                                <p class="whatsapp-message">Hi</p>
                                <p class="whatsapp-timestamp">${now.toLocaleString()}</p>
                            </div>
                        </div>`;
