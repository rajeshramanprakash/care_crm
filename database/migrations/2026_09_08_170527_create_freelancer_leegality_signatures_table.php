...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('freelancer_leegality_signatures')) {
            return;
        }

        Schema::create('freelancer_leegality_signatures', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('freelancer_leegality_signatures');
    }
};
