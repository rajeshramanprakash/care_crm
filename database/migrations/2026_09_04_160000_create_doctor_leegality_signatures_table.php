...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('doctor_leegality_signatures')) {
            return;
        }

        Schema::create('doctor_leegality_signatures', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('doctor_request_id')->index();
    ...
    {
        Schema::dropIfExists('doctor_leegality_signatures');
    }
};
