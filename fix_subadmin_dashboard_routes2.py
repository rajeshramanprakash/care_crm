...
target_line = r"Route::get\('/dashboard', \[Controllers\\SubAdmin\\SubAdminController::class, 'dashboard'\]\)->name\('subadmin\.dashboard'\);"
if "getUnverifiedDeploymentPaymentsStats" not in content:
    ...
    with open(file_path, 'w') as f:
        f.write(content)
    print("Added missing dashboard routes via regex.")
else:
    print("Routes already present or target line not found via regex.")
